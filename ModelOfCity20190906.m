...
for model=1
% for model=[length(model_space)-3 length(model_space)-2 length(model_space)-1]
%for model=[[1 6 11 16 21 26 31] [1 6 11 16 21 26 31]+35]+2
%for model=[1 6 11 16 21 26 31]+35
%for model= [16 21 26 31]+35+2
