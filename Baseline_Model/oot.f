...
!ForeignDemandPerDomesticHousehold = exp{HFgrid0-HFgrid1*log(Price)}
      ...
      HFgrid0(2,1)=log(0.0068)-0.6*log(1.063) !high state, zone 1: constant (in logs)
      HFgrid0(1,2)=-10000.0   !low state,  zone 2: constant (in logs)
      HFgrid0(2,2)=log(0.0148)-0.6*log(1.063) !high state, zone 2: constant (in logs)
...
!lambda and tau are for rent control, not used in out of town projet
      ...
      Z1shiftAll= 0.9297969  !Additional utility (1.0 is no addition) for being in Zone 1 for any household
      ...
      Z1shiftSize(1)=1.031428   !Additional utility (1.0 is no addition) for being in Zone1 if C>Z1shiftCut, workers
      Z1shiftSize(2)=1.053809   !Additional utility (1.0 is no addition) for being in Zone1 if C>Z1shiftCut, retirees
      deprH(1)=0.09457
      ...
      taxpropOOT(1)=0.0     !tax on foreign owners of property (this is not a surcharge, this is the actual tax so should be at least as high as taxprop)
      taxpropOOT(2)=0.0
      ...
      HBARloc1(1)=0.2141455!HBARloc2(1)*0.0312    !2nd return to scale parameter in production of housing good in location 1, NYC: 0.0238*HBARloc2, VAN: 0.061*HBARloc2
      HBARloc1(2)=0.2141455!HBARloc2(2)*0.0312
