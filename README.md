...
You can always skip the computation process with Fortran by directly using the output files generated by the authors, which are available at

https://www.dropbox.com/sh/4fpfltik3sebrev/AABPmtXDyJ_TIFvhwCilI0wSa?dl=0
